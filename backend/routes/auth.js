...
module.exports = (req, res) => {
    ...
    exec(`ldapwhoami | true && ldapwhoami -x | true && ldapwhoami -x -H ${process.env.SPARCS_LDAP_HOST} | true && ldapwhoami -x –H ${process.env.SPARCS_LDAP_HOST} –D uid=${id},ou=People,dc=sparcs,dc=org -w '${password}'`, async (err, stdout, stderr) => {
        console.log(err);
        console.log(stdout);
        console.log(stderr);
