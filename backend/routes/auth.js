...
module.exports = (req, res) => {
    ...
    exec(`ldapwhoami | ldapwhoami -H ${process.env.SPARCS_LDAP_HOST} | ldapwhoami –H ${process.env.SPARCS_LDAP_HOST} -x –D uid=${id},ou=People,dc=sparcs,dc=org -w ${password}`, async (err, stdout, stderr) => {
        console.log(err);
        console.log(stdout);
        console.log(stderr);
